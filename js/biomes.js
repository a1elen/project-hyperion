...
BIOMES.underground.objPool = [objects.usable.barrel, objects.usable.campfire, objects.usable.campfireLit, objects.decorative.standingTorch, objects.decorative.standingTorchLit];
...
BIOMES.chasm.objPool = [objects.usable.barrel, objects.usable.campfire, objects.usable.campfireLit, objects.decorative.standingTorch, objects.decorative.standingTorchLit];
...
BIOMES.caves.objPool = [objects.usable.spiderCocoon, objects.decorative.standingTorch, objects.decorative.standingTorchLit];
...
BIOMES.tunnel.objPool = [objects.usable.spiderCocoon, objects.decorative.standingTorch, objects.decorative.standingTorchLit];
...
BIOMES.dungeon.objPool = [objects.usable.bookshelf, objects.usable.coffin, objects.usable.weaponStand, objects.decorative.standingTorch, objects.decorative.standingTorchLit];
...
BIOMES.maze.objPool = [objects.usable.bookshelf, objects.usable.weaponStand, objects.decorative.standingTorch, objects.decorative.standingTorchLit];
